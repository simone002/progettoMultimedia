...
Per includere anche la fase di costruzione del dataset, è stato aggiunto uno script dedicato:
\texttt{extract\_characters\_cvl.py}.

Lo script opera su immagine singola o in batch e realizza:
\begin{enumerate}[leftmargin=1.5em]
  \item conversione in grayscale,
  \item binarizzazione adattiva + denoising,
  \item pulizia morfologica (erode/dilate con opening opzionale),
  \item estrazione componenti connesse e bounding box dei caratteri,
  \item filtri geometrici su area, dimensioni e aspect ratio,
  \item filtro outlier basato su mediane (area/altezza) per ridurre falsi positivi,
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{output/classification_advanced/organized/03_ablation/ablation_delta_macro_f1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{output/analysis/plots/feature_correlation_heatmap.png}
    \caption{Heatmap di correlazione (gruppi di feature).}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{output/analysis/plots/feature_space_pca_2d.png}
    \caption{PCA 2D del feature space.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/confusion_matrices/raw/confusion_matrix_xgboost.png}
    \caption{Confusion matrix del modello XGBoost (holdout).}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/confusion_matrices/raw/confusion_matrix_svm_rbf.png}
  \caption{Confusion matrix del modello SVM RBF (holdout).}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/confusion_matrices/raw/confusion_matrix_extra_trees.png}
  \caption{Confusion matrix del modello ExtraTrees (holdout).}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/confusion_matrices/normalized/confusion_matrix_xgboost_normalized.png}
  \caption{Confusion matrix normalizzata del modello XGBoost.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/confusion_matrices/normalized/confusion_matrix_svm_rbf_normalized.png}
  \caption{Confusion matrix normalizzata del modello SVM RBF.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/confusion_matrices/normalized/confusion_matrix_extra_trees_normalized.png}
  \caption{Confusion matrix normalizzata del modello ExtraTrees.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/feature_importance/xgboost_feature_importance_top20.png}
  \caption{Feature importance (Top-20) del modello XGBoost.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{output/classification_advanced/organized/04_diagnostics/f1_by_letter/f1_by_letter_xgboost.png}
